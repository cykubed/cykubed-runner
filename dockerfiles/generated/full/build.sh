#!/bin/bash
set -e
docker build -t us-docker.pkg.dev/cykubed/public/base-runner:3.18.3 -f dockerfiles/base/runner/Dockerfile .
docker push -a us-docker.pkg.dev/cykubed/public/base-runner
docker build -t us-docker.pkg.dev/cykubed/public/node-16:3.18.3 -f dockerfiles/generated/full/node-16/Dockerfile .
docker push -a us-docker.pkg.dev/cykubed/public/node-16
docker build -t us-docker.pkg.dev/cykubed/public/node-16-firefox:3.18.3 -f dockerfiles/generated/full/node-16-firefox/Dockerfile .
